...
4. Submit — the automation runs every 10 minutes and will post a confirmation comment and close
   the issue once your repo has been added.
...
| Exempt Request Processor | Every 10 minutes | Processes exemption requests submitted via issues in this repo |
